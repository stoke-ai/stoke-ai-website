    ...
    discovery: [
      {
        ...
        status: 'Complete',
        detail: 'Reordered the public homepage so prospects see results first, then Jeff’s local credibility, then the working model and portal rhythm.',
      },
      {
        ...
        status: 'Defined',
        detail: 'Position Stoke AI as an ongoing operating partner for established Magic Valley businesses rather than a self-serve AI tool or one-off automation vendor.',
      },
    ],
    'building-now': [
      {
        ...
        status: 'In progress',
        detail: 'Build a simple private workspace where each client can see priorities, progress, decisions needed, and recent activity without operational jargon.',
      },
      {
        ...
        detail: 'Create a test login for Jeff to experience the portal as a client before giving access to Austin, Kevin, or future customers.',
      },
    ],
    'up-next': [
      {
        ...
        detail: 'Decide whether the first real version stays concierge-managed by Blaze or upgrades to Supabase/Clerk for email/password, password resets, and multiple team members per client.',
      },
      {
        ...
        detail: 'Turn the sample Austin & Kevin workspace into a client-ready portal once their business name, first priorities, and access needs are confirmed.',
      },
      {
        ...
        status: 'Planned',
        detail: 'Create an internal queue for Magic Valley prospects, conversations, follow-ups, and next best actions so sales activity does not disappear into chat threads.',
      },
    ],
    'waiting-blocked': [
      {
