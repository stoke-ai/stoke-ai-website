 ...
 return <div className="deck fastDeck">
  ...
  <main className="fastMain">
   ...
   <details className="evidence"><summary>Need more information?</summary><div className="evidenceBody">
    {item.hcpEstimateUrl&&<a className="hcpEstimateLink" href={item.hcpEstimateUrl} target="_blank" rel="noopener noreferrer">Open Estimate {item.estimateNumber} in HCP ↗</a>}
    {!item.hcpEstimateUrl&&<p className="hcpEstimateHint">Direct HCP link unavailable for this estimate.</p>}
