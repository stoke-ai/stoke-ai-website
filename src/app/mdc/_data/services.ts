...
export const installation: ServicePageData = {
  ...
  intro: "Morgan Door helps Southern Idaho homeowners choose and install Raynor and Hörmann garage doors without the catalog overload. Get clear guidance on style, insulation, windows, finish, and operation—then a precise installation from a trained local team.",
  ...
  differentiators: [
    ...
    { title: "Raynor and Hörmann quality", copy: "Two residential lines give you durable steel, insulation, window, and design options without sacrificing serviceability." },
  ...
  process: [
    ...
    { title: "Measure and choose", copy: "We verify the opening and help compare practical Raynor and Hörmann styles, insulation levels, windows, and finishes." },
  ...
  localProof: [
    ...
    "Raynor and Hörmann doors for homes and businesses",
...
export const commercial: ServicePageData = {
  ...
  differentiators: [
    ...
    { title: "Raynor and Hörmann commercial options", copy: "Sectional, insulated, and specialty solutions can be matched to the opening and operating demands." },
