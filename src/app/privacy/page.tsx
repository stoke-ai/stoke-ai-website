...
export default function PrivacyPage() {
  return <main className="min-h-screen bg-[#0d0d0d] text-white"><div className="mx-auto max-w-4xl px-5 py-8 sm:px-8 sm:py-12">
    ...
    <div className="mt-10 space-y-9 text-base leading-7 text-gray-300"><section><h2 className="text-xl font-black text-white">Who we are</h2><p className="mt-2">This Privacy Policy applies to JHEKOO LLC doing business as Stoke AI (“Stoke AI,” “we,” “us,” or “our”), including stoke-ai.com, client workspaces, forms, and related services.</p></section>{sections.map((section) => <section key={section.title}><h2 className="text-xl font-black text-white">{section.title}</h2><p className="mt-2">{section.body}</p></section>)}<section><h2 className="text-xl font-black text-white">Contact us</h2><p className="mt-2">JHEKOO LLC dba Stoke AI<br />Burley, Idaho<br /><a className="text-orange-300 underline" href="mailto:compliance@stoke-ai.com">compliance@stoke-ai.com</a></p></section></div>
